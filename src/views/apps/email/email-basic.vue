                            ...
                            <div class="content"
                                ...
                                <div style="text-align: center; margin: 0px auto;">
                                    <ul
                                        ...
                                        <li>
                                            <b-link href="#" style="color: #495057;">Help Center</b-link>
                                        </li>
                                        <li>
                                            <b-link href="#" style="color: #495057;">Support 24/7</b-link>
                                        </li>
                                        <li>
                                            <b-link href="#" style="color: #495057;">Account</b-link>
                                        </li>
                                    </ul>
                                    <p
                            ...
                            <div class="content"
                                ...
                                <div
                                    ...
                                    <p style="color: #878a99; line-height: 1.5;">Please send and feedback or bug info to
                                        <b-link href="" style="font-weight: 500;">info@velzon.com</b-link>
                                    </p>
                                    <p
                                        style="font-family: 'Roboto', sans-serif; font-size: 14px;color: #98a6ad; margin: 0px;">
                                        2022 Velzon. Design & Develop by Themesbrand</p>
