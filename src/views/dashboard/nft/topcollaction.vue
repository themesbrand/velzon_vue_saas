                                ...
                                <div>
                                    <div class="dropdown float-end">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <b-link class="dropdown-item" href="javascript:void(0);">View</b-link>
                                            </li>
                                            <li>
                                                <b-link class="dropdown-item" href="javascript:void(0);">Share</b-link>
                                            </li>
                                            <li>
                                                <b-link class="dropdown-item" href="#!">Report</b-link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
